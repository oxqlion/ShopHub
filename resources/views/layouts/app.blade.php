                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                @if (Auth::user()->is_admin)
                                    ...
                                    <a href="{{ route('indexOrder') }}">Order</a>
                                @else
                                    <a href="{{ route('indexOrder') }}">Order</a>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    @if (Auth::user()->is_admin)
                                        <a class="dropdown-item" href="{{ route('createProduct') }}">
                                            Create product
                                        </a>
                                    @else
                                        <a class="dropdown-item" href="{{ route('showCart') }}">
                                            Cart
                                        </a>
                                    @endif

                                    <a class="dropdown-item" href="{{ route('indexOrder') }}">
                                        Order
                                    </a>
